...
class DemToTactilePlugin:
    """Classe principal de integração do QGIS para o plugin DEM to Tactile 3D."""  # noqa: E501
    ...
    def initGui(self):
        ...
        self.action.setStatusTip(
            "Transforma um MDE e vetores em um modelo 3D tátil fechado (STL)")
        self.action.setWhatsThis(
            "Plugin para geração de modelos físicos 3D táteis a partir de relevo raster e vetores.")  # noqa: E501
    ...
    def unload(self):
        """Remove os elementos de interface criados pelo plugin ao desativá-lo."""  # noqa: E501
        if self.action:
    ...
    def run(self):
        """Executa a rotina principal do plugin abrindo o diálogo de configurações."""  # noqa: E501
        # Criar o diálogo se for a primeira execução
        if self.dialog is None:
            self.dialog = DemToTactileDialog(
        ...
        # Compatibilidade PyQt5 / PyQt6 (exec_ foi removido no PyQt6)
